            ...
            <div class="bg-white shadow-sm rounded p-3">
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            <h1 class="mb-2 fs-20 fw-600">
                              {{ $detailedProduct->brand->name.' '.$detailedProduct->name }}
                            </h1>
                            ...
                            <div class="row no-gutters mt-3">
                                <div class="col-auto">
                                    <?php echo $detailedProduct->getTranslation('spesification'); ?>
                                </div>

                            </div>
                            <div class="mt-3">
                                <div style="display: flex;">
                                    <a class="btn btn-warning">PREMIUM: {{ single_price($detailedProduct->unit_price) }}/{{$detailedProduct->unit}}</a>
                                    <a class="btn btn-warning">Inquire Now!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="p-3">
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="3"
                                ...
                                @foreach (filter_products(\App\Models\Product::where('brand_id', $detailedProduct->brand_id)->where('id', '!=', $detailedProduct->id))->limit(10)->get() as $key => $related_product)
