    ...
    @endforeach
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{ translate('Unit Price') }}
                                  </label>
                                <div class="col-lg-6">
    ...
    @endforeach
                    ...
                    <!--<div class="card">
                     ...
                     <input type="hidden" lang="en"
                                            ...
                                            placeholder="{{ translate('Quantity') }}" name="current_stock"
                                            class="form-control">
                    <input type="hidden" lang="en" min="0" step="0.01"
                                        placeholder="{{ translate('Discount') }}" name="discount" class="form-control"
                                        value="{{ $product->promo_price }}" required>
                        <input type="hidden" class="form-control aiz-date-range"
                                        @if ($product->discount_start_date && $product->discount_end_date) value="{{ $start_date . ' to ' . $end_date }}" @endif
                                        name="date_range" placeholder="{{ translate('Select Date') }}"
                                        data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to "
                                        autocomplete="off">
                     <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6">{{ translate('Spesification Of Product') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-lg-3 col-from-label">{{ translate('Description') }} <i
                                        ...
                                        title="{{ translate('Translatable') }}"></i></label>
                                <div class="col-lg-9">
                                    <textarea class="aiz-text-editor" name="spesification">{{ $product->getTranslation('spesification', $lang) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
