         ...
         <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{translate('M1 Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        <input type="hidden" name="payment_method" value="m1">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="M1_CLIENT_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('M1 Client Id')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="M1_CLIENT_ID" value="{{  env('M1_CLIENT_ID') }}" placeholder="{{ translate('M1 Client ID') }}" required>
                            </div>

                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="M1_CLIENT_SECRET">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('M1 Client Secret')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="M1_CLIENT_SECRET" value="{{  env('M1_CLIENT_SECRET') }}" placeholder="{{ translate('M1 Client Secret') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="M1_PRIVATE_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('M1 Private Key')}}</label>
                            </div>
                            <div class="col-md-8">
                                <textarea style="height:200px" class="form-control" name="M1_PRIVATE_KEY" required>{{  env('M1_PRIVATE_KEY') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('M1 Sandbox Mode')}}</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="m1_sandbox" type="checkbox" @if(get_setting('m1_sandbox') == 1)
                                        checked
                                    @endif>
