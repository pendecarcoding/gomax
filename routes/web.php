...
use App\Http\Controllers\ace\GomaxController;
use App\Http\Controllers\RequestPatner;


$controllerName = env('ACTIVE_CONTROLLER', 'AceController');
$controllerClass = config('app.controllers.' . $controllerName);
if (!class_exists($controllerClass)) {
    $controllerClass = AceController::class;
}
